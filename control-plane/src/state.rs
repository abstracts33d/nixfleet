...
mod tests {
    ...
    fn test_get_or_create_inserts_new() {
        ...
        let machine = state.get_or_create("krach");
    ...
    fn test_get_or_create_returns_existing() {
        let mut state = FleetState::new();
        state.get_or_create("krach").desired_generation = Some(DesiredGeneration {
    ...
    fn test_multiple_machines() {
        let mut state = FleetState::new();
        state.get_or_create("krach");
        state.get_or_create("ohm");
        state.get_or_create("aether");
