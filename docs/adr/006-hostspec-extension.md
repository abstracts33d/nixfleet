...
The framework defines a minimal set of hostSpec options (identity fields + capability flags). Fleet repos need additional flags for their opinionated scopes (e.g., `isGraphical`, `isDev`, `useDesktop`, `theme`).
