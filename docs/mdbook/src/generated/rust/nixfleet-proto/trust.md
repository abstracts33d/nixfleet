...
- **`CURRENT_SCHEMA_VERSION`** — The only `schemaVersion` value this crate parses. Binaries match on
...
- **`active_keys`** — Returns the active key list for this slot. Both `current` and
