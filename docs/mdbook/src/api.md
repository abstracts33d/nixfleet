...
The full Rust API reference for every crate in this workspace is generated by `cargo doc --document-private-items` and published alongside this book at **[`./api/`](./api/index.html)**.
