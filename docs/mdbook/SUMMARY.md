...
- [Design Guarantees](guide/getting-started/design-guarantees.md)
- [Installation](guide/getting-started/installation.md)

## Defining Hosts

- [The mkHost API](guide/defining-hosts/mkhost.md)
- [hostSpec Configuration](guide/defining-hosts/hostspec.md)
- [Scopes](guide/defining-hosts/scopes.md)
- [Cross-Platform](guide/defining-hosts/cross-platform.md)
...
- [Fleet Status](guide/operating/fleet-status.md)
- [Rollback](guide/operating/rollback.md)
- [Impermanence](guide/operating/impermanence.md)
...
- [mkHost API](reference/mkhost-api.md)
- [hostSpec Options](reference/hostspec-options.md)
...
- [Core Darwin Module](reference/core-darwin.md)
