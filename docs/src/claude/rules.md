...
7 rule files in `.claude/rules/` providing domain-specific guidance. These are project-level rules (git-tracked) that apply to all Claude sessions in this repo.
