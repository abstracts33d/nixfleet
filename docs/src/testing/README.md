...
Tests follow a 3-tier pyramid ensuring config correctness at build time and runtime behavior in VMs, with future smoke tests on live hardware.
...
| **B** | Smoke | -- | `smoke.sh` (future) | Post build-switch |
