...
| File | Topic |
|------|-------|
| [operations/quickstart.md](operations/quickstart.md) | Minimum path from a fresh repo to a single managed host |
| [operations/operator-cookbook.md](operations/operator-cookbook.md) | Tasks the operator does, with concrete commands |
| [operations/bootstrap-token-lifecycle.md](operations/bootstrap-token-lifecycle.md) | Bootstrap token mint / consume / rotate |
| [operations/vm-lifecycle.md](operations/vm-lifecycle.md) | `mkVmApps` subcommands for local VM testing |
| [operations/testing.md](operations/testing.md) | `nix run .#validate` modes and what each runs |
