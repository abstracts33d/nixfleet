...
- `docs/superpowers/specs/2026-03-25-day2-operations-design.md` — Full operational spec
- `agent/src/main.rs` — Agent poll loop and state machine
- `control-plane/src/routes.rs` — API endpoints for fleet management
