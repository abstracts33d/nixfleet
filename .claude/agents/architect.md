...
- `docs/superpowers/specs/2026-03-25-S1-multi-org-hosts.md` — S1+S2 design
- `docs/superpowers/specs/2026-03-25-S3-fleet-agent.md` — Agent architecture
- `docs/superpowers/specs/2026-03-25-S8-open-core-licensing.md` — Open-core strategy
