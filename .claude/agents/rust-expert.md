...
2. `cargo test --workspace` — run all 139 tests
...
MUST use `systematic-debugging` skill for compilation errors. Use `verification-before-completion` before claiming fixed.
