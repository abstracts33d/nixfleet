...
mod tests {
    ...
    fn test_glob_match_prefix() {
        assert!(glob_match("krach*", "krach"));
        assert!(glob_match("krach*", "krach-qemu"));
        assert!(!glob_match("krach*", "ohm"));
    }

    #[test]
    fn test_glob_match_suffix() {
        assert!(glob_match("*-qemu", "krach-qemu"));
        assert!(!glob_match("*-qemu", "krach-utm"));
    }
    ...
    fn test_filter_hosts_no_match() {
        let hosts = vec!["krach".into(), "ohm".into()];
