...
Scope modules are plain NixOS/Darwin modules that self-activate with `lib.mkIf hS.<flag>` and co-locate impermanence persist paths. Framework scopes: base, impermanence, agent, control-plane. Fleet scopes: graphical, dev, desktop, display, hardware, darwin.
