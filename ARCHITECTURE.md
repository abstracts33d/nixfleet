...
The principle is *"the CP holds nothing whose loss creates a security regression on rebuild, and nothing whose loss creates more than a one-window operational regression."* That is the strict reading of done-criterion #1; gaps A + B + C (#46/#47/#48) are what make it true.
